...
export default function Dashboard() {
  ...
  const topMuscles = [...user.muscles].sort((a, b) =>
    ...
    <div className="space-y-5">
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="w-12 h-12 rounded-2xl bg-accent/30 border border-accent/40 flex items-center justify-center font-extrabold text-lg shadow-glow">
      ...
      <div className="grid grid-cols-2 gap-3">
        <StatCard label="Streak" value={`${user.streak} 🔥`} sub="days in a row" accent="#ff8a3d" icon="🔥" />
